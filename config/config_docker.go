...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"smischgp_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"smischgp_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the smischgp containers are started with user namespace
	// remapping disabled
