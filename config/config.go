...
const DefaultLocation = "/etc/smischgp/config.yml"
...
type SystemConfiguration struct {
	// The root directory where all of the smischgp data is stored at.
	RootDirectory string `default:"/var/lib/smischgp" yaml:"root_directory"`

	// Directory where logs for server installations and other wings events are logged.
	LogDirectory string `default:"/var/log/smischgp" yaml:"log_directory"`

	// Directory where the server data is stored at.
	Data string `default:"/var/lib/smischgp/volumes" yaml:"data"`

	// Directory where server archives for transferring will be stored.
	ArchiveDirectory string `default:"/var/lib/smischgp/archives" yaml:"archive_directory"`

	// Directory where local backups will be stored on the machine.
	BackupDirectory string `default:"/var/lib/smischgp/backups" yaml:"backup_directory"`

	// TmpDirectory specifies where temporary files for SmischGP installation processes
	// should be created. This supports environments running docker-in-docker.
	TmpDirectory string `default:"/tmp/smischgp" yaml:"tmp_directory"`

	// The user that should own all of the server files, and be used for containers.
	Username string `default:"smischgp" yaml:"username"`
...
type Configuration struct {
	...
	AppName string `default:"SmischGP" json:"app_name" yaml:"app_name"`
...
// EnsureSmischGPUser ensures that the SmischGP core user exists on the
...
func EnsureSmischGPUser() error {
	...
	if sysName == "distroless" {
		_config.System.Username = system.FirstNotEmpty(os.Getenv("WINGS_USERNAME"), "smischgp")
	...
	log.WithField("username", _config.System.Username).Info("checking for smischgp system user")
