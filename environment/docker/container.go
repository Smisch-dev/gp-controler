...
func (e *Environment) Create() error {
	...
	for i, v := range evs {
		// Convert 127.0.0.1 to the smischgp0 network interface if the environment is Docker
...
func (e *Environment) Destroy() error {
	...
	//
	// @see https://github.com/Smisch-dev/gp-controler/panel/issues/2001
