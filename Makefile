...
debug:
	go build -ldflags="-X github.com/Smisch-dev/gp-controler/wings/system.Version=$(GIT_HEAD)"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/Smisch-dev/gp-controler/wings/system.Version=$(GIT_HEAD)" -race
